    ...
    <div class="box-body">
      <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="credito" type="text" class="form-control @error('credito') is-invalid @enderror" name="credito" value= "0">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="status" type="st" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
